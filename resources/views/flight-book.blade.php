    ...
    <main>
        <div class="container">
            ...
            <div class="row">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" value="<?php  ?>" class="form-control">
                                        </div>
                                        <div class="col-sm-6">
                                            <label class="control-label">
                                                Last Name:
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="tel" value="<?php  ?>" class="form-control">
                                        </div>
                                        <div class="col-sm-6">
                                            <label class="control-label">
                                                Contact's email address
                                            </label>
                                            <input type="email" name="user_email" value="<?php  ?>" class="form-control">
                                        </div>
                                    </div>
                ...
                <div class="col-md-4">
                @foreach($book as $books) <!-- Duyet array use for or foreach ok -->
                    <h3>Flights</h3>
                    <aside>
                        <article>
                            <div>
                                <ul class="list-group">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div><small class="airport">{{$books[0]->airport_from}}</small></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div><span class="place"></span></div>
                                                        <div><small class="airport">{{$books[0]->airport_to}}</small></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li class="list-group-item">
                                        <h5>
                                            <strong class="airline">{{$books[0]->airways_name}} {{$books[0]->code}}</strong>
                                            <p><span class="flight-class">Economy</span></p>
                                        </h5>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div><big class="time">{{$books[0]->time_from}}</big></div>
                                                        <div><small class="date">30 Apr 2019</small></div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div><span class="place">{{$books[0]->place_from}}</span></div>
                                                        <div><small class="airport">{{$books[0]->airport_from}}</small></div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div><big class="time">{{$books[0]->time_to}}</big></div>
                                                        <div><small class="date">30 Apr 2019</small></div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div><span class="place">{{$books[0]->place_to}}</span></div>
                                                        <div><small class="airport">{{$books[0]->airport_to}}</small></div>
                                                    </div>
                                                </div>
                                            </div>
